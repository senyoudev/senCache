...
/**
 * This class is used to serialize objects to JSON format. It uses the Jackson library to perform
 * the serialization.
 *
 * @param <T>
 */
public final class JsonSerializer<T> implements Serializer<T> {
  ...
  public byte[] serialize(T object) throws SerializationException {
    ...
    try {
      ...
      LOGGER.info(
          "Serialized object of type {} to JSON: {}",
          object.getClass().getName(),
          new String(data));
      return data;
    } catch (JsonProcessingException e) {
      throw new SerializationException(
          "Error serializing object of type: " + object.getClass().getName(), e);
    } catch (Exception e) {
